...
class GameProtocolShapesTest {
    ...
    fun passiveWireDryRunPlannerBuildsObservedBatchRefillPrepareAndDispatchChain() {
        ...
        assertEquals(
            "0000000000000000001a1520030200000000006b4dac0000000000686b990000000000424de2",
            plan.prepareGameHex
        )
        assertEquals(
            "0000000000000000001a15200000030200000000006b4dac0000000000686b990000000000424de2",
            plan.prepareCapturedWireTail
        )
        assertEquals(
            "000000000000000000251522030200000000006b4dac0000000000686b990000000000424de2ffffffffffffffff000000",
            plan.dispatchGameHex
        )
        assertEquals(
            "0000000000000000002515220000030200000000006b4dac0000000000686b990000000000424de2ffffffffffffffff000000",
